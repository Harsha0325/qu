...
export function CardTable() {
  ...
  useEffect(() => {
    const fetchCards = async () => {
      try {
        ...
        const response = await api.get(`/user-card-ids/${userId}/cards`);
  ...
  return (
    ...
    <div className='text-2xl font-semibold mt-8'>Assigned Cards</div>
    <div className="mt-8 border flex overflow-hidden overflow-x-auto flex-wrap items-start bg-white max-md:max-w-full">

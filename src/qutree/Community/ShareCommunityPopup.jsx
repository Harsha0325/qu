...
const ShareCommunityPopup = ({ url, onClose, communityName,}) => {
  ...
  //     link.download = `${communityName}.png`;
  //     link.click();
  //   });
  // };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'Inter', fontSize: '1.5rem', color: '#000000', paddingBottom: '20px' }}>Share Community</div>
...
export default ShareCommunityPopup;
